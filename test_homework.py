...
def read_function_name(function, *args):
...
def open_browser(browser_name):
    actual_result = read_function_name(open_browser, browser_name)
    assert actual_result == "Open Browser [Chrome]"


def go_to_companyname_homepage(page_url):
    actual_result = read_function_name(go_to_companyname_homepage, page_url)
